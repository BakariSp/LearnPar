...
import { getCurrentUser, UserProfile, isAuthenticated, logout } from '../../services/auth';
    ...
    const fetchUserData = async () => {
      ...
      try {
        ...
        if (userData) {
          ...
          // If we couldn't get user data despite having a token, the token might be invalid
          logout();
          router.push('/login');
        }
      } catch (error) {
